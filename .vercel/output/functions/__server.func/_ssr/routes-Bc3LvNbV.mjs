...
import { n as SiteFooter, r as SiteNav, t as OptimizedImage } from "./SiteFooter-DsbE5ZVl.mjs";
import { n as butterfly_img_default$1, t as butterfly_img_default } from "./butterfly-img-DGXirbV2.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-Bc3LvNbV.js
...
function Featured() {
	...
	if (featured.length === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		id: "collection",
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "No featured categories"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 font-mono text-[10px] uppercase tracking-[0.24em] text-chrome-dim",
						children: "Mark collections as featured in the admin panel"
					})]
				})
			]
		})
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CategoryCase, {
					...
					}), rest.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: "/shop",
...
function CategoryCase({ imageUrl, number, name, objects, tall, priority }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: `relative overflow-hidden ${tall ? "aspect-[4/5] md:aspect-auto md:h-[820px]" : "aspect-[16/10] md:aspect-auto md:h-[398px]"}`,
			children: [
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "font-display text-lg md:text-xl text-chrome",
				children: name
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "font-mono text-xs tracking-[0.14em] text-chrome-dim",
				children: [
					objects,
					" object",
					objects !== 1 ? "s" : ""
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				allProducts.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex flex-col items-center justify-center py-20 text-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-display text-3xl text-chrome-dim italic",
						...
						className: "mt-3 font-mono text-[10px] uppercase tracking-[0.24em] text-chrome-dim",
						children: "Add products in the admin panel"
					})]
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-6",
					children: allProducts.slice(0, 4).map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: "/products/$slug",
						params: { slug: p.slug },
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SmallCase, {
...
function SmallCase({ imageUrl, name, price }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
		"data-cursor": "hover",
		initial: { clipPath: "inset(100% 0 0 0)" },
		whileInView: { clipPath: "inset(0 0 0 0)" },
...
function Categories() {
	...
	const cats = (0, import_react.useMemo)(() => {
		if (collections.length > 0) return collections.filter((c) => c.isActive).map((c) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "divider-chrome mb-14" }),
				cats.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex flex-col items-center justify-center py-20 text-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-display text-3xl text-chrome-dim italic",
						...
						className: "mt-3 font-mono text-[10px] uppercase tracking-[0.24em] text-chrome-dim",
						children: "Create collections in the admin panel"
					})]
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "grid grid-cols-1 md:grid-cols-4 gap-4",
					children: cats.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: c.link,
						"data-cursor": "hover",
						className: "group relative block overflow-hidden rounded-3xl border border-chrome",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "aspect-[3/4] overflow-hidden bg-graphite-2 flex items-center justify-center",
								children: c.imageUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
									...
									className: "font-display text-6xl text-chrome-dim/20 italic",
