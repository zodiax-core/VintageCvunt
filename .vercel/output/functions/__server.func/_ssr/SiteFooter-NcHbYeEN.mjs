...
//#region node_modules/.nitro/vite/services/ssr/assets/SiteFooter-NcHbYeEN.js
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: "/admin",
								className: "relative transition-colors hover:text-black/40",
								children: "Admin"
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							isAdmin ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								...
								className: "hidden md:inline font-mono text-[11px] text-chrome truncate max-w-[100px]",
