...
import { D as MessageSquare, E as Package, I as ExternalLink, J as Bell, K as ChartColumn, M as LayoutDashboard, O as Menu, P as FileText, U as ChevronLeft, g as Search, h as Settings, j as LogOut, l as Tag, n as Users, p as ShoppingBag, r as User, u as Star } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/AdminLayout-DMRer5-I.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
						className: "fixed bottom-0 left-0 right-0 z-40 flex items-center justify-around border-t border-chrome/20 bg-background/95 backdrop-blur-xl px-2 py-1 md:hidden",
