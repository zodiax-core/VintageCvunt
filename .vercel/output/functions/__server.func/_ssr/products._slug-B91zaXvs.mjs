...
import { t as Route } from "./products._slug-Cv6EsNqu.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/products._slug-B91zaXvs.js
...
function ProductPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			product.video && product.imageUrls?.[0] && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingVideo, { videoUrl: product.video }),
