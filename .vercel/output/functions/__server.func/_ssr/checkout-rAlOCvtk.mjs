...
//#region node_modules/.nitro/vite/services/ssr/assets/checkout-rAlOCvtk.js
									...
									children: [
											...
											children: shippingRates.map((rate) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
												...
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														...
														children: priceLabel(rate.price)
													})
												]
											}, rate._id))
										})] }),
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														...
														children: shippingCost === 0 ? "Free" : priceLabel(shippingCost)
													})]
												}),
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												children: priceLabel(grandTotal)
											})]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											type: "submit",
...
async function queryValidateCoupon(code, subtotal) {
	const { getConvexClient } = await import("./convex-CYVJ-0GO.mjs");
	const { api } = await import("./api-xr_VpTVu.mjs").then((n) => n.n).then((n) => n.n);
