...
import { t as Route } from "./products._slug-DXBKiqu4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/products._slug-BF793lw2.js
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
										src: product.variants && selectedColor && product.variants.find((v) => v.name === selectedColor)?.imageUrl || product.imageUrls?.[selectedImage] || product.imageUrls?.[0] || "/placeholder.svg",
										alt: product.name,
										className: "h-full w-full object-cover"
									})
								})
							}), product.imageUrls && product.imageUrls.length > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "flex gap-3 overflow-x-auto pb-2 scrollbar-thin",
								children: product.imageUrls.map((url, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												...
												children: product.variants.map((v, i) => {
													return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
														onClick: () => {
															...
															setSelectedSize("");
															if (v.imageUrl && product.imageUrls) {
																const imgIdx = product.imageUrls.indexOf(v.imageUrl);
																if (imgIdx !== -1) setSelectedImage(imgIdx);
															}
														},
														className: `rounded-lg border px-3 py-1.5 font-mono text-[11px] transition-colors ${selectedColor === v.name ? "border-chrome bg-chrome text-background" : "border-chrome/30 bg-graphite text-chrome hover:border-chrome/60"}`,
														children: v.name
													}, i);
												})
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
												className: "mt-2 font-mono text-[9px] text-chrome-dim",
												children: ["Price: ", formatPrice(product.price)]
											})
										]
									}),
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
											...
											onClick: () => {
												addToCart({
													...
													name: product.name,
													slug: product.slug,
													src: selectedColor && product.variants?.find((v) => v.name === selectedColor)?.imageUrl || product.imageUrls?.[0] || "/placeholder.svg",
													webp: selectedColor && product.variants?.find((v) => v.name === selectedColor)?.imageUrl || product.imageUrls?.[0] || "/placeholder.svg",
													price: product.price,
													selectedSize: selectedSize || void 0,
													selectedColor: selectedColor || void 0
												});
											},
											className: "btn-chrome bg-chrome text-white hover:bg-chrome-h hover:text-white w-full justify-center text-sm !py-4 font-mono uppercase tracking-[0.2em] font-semibold",
											children: "Buy Now"
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "btn-label",
												children: addedToCart ? "Added ✓" : `Add to Cart — ${formatPrice(product.price)}`
											})
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
