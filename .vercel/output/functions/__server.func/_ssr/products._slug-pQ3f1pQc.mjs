...
import { t as Route } from "./products._slug-B_v9VuX7.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/products._slug-pQ3f1pQc.js
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													className: "h-9 w-9 rounded-full border border-chrome bg-graphite-2 grid place-items-center font-mono text-xs text-chrome shrink-0",
													children: r.customerName.charAt(0)
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "font-mono text-sm text-foreground",
													children: r.customerName
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "block font-mono text-[10px] uppercase tracking-[0.2em] text-chrome-dim/60 mt-0.5",
										...
										r.title && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "font-mono text-sm text-foreground font-semibold mb-2",
											children: r.title
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-base text-chrome-dim leading-relaxed",
											children: r.comment
										})
									]
								}, r._id))
