...
import { D as MessageSquare, E as Package, F as FileText, L as Ellipsis, M as LayoutDashboard, N as House, O as Menu, W as ChevronLeft, Y as Bell, g as Search, h as Settings, j as LogOut, l as Tag, n as Users, p as ShoppingBag, q as ChartColumn, r as User, u as Star } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/AdminLayout-BzUk_VCo.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
						className: "flex-1 p-4 lg:p-6 overflow-auto pb-20 md:pb-6",
						children
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
						className: "fixed bottom-0 left-0 right-0 z-40 flex items-center justify-around border-t border-chrome/20 bg-background/95 backdrop-blur-xl px-1 py-1 md:hidden",
						children: MOBILE_NAV.map((item) => {
							...
							if (item.action === "sidebar") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { size: 16 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: item.to,
								className: `flex flex-col items-center gap-0.5 rounded-lg px-3 py-2 transition-colors ${active ? "text-foreground" : "text-chrome-dim"}`,
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { size: 16 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "font-mono text-[8px] uppercase tracking-[0.15em]",
									children: item.label
								})]
