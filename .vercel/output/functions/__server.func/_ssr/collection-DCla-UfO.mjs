...
import { S as Save, d as Trash2, j as PenLine, o as Upload, p as Star, st as CircleAlert } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/collection-DCla-UfO.js
...
function CollImage({ url, size = "h-10 w-10" }) {
	if (!url) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: `${size} rounded-lg bg-chrome/10 flex items-center justify-center font-mono text-xs text-chrome-dim`,
		children: "—"
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
		src: url,
		alt: "",
		className: `${size} rounded-lg object-cover border border-chrome/20`
	});
}
function Collections() {
	...
	const [existingImageUrl, setExistingImageUrl] = (0, import_react.useState)("");
	...
	const [imagePreviewUrl, setImagePreviewUrl] = (0, import_react.useState)("");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AdminLayout, { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [imagePreviewUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								src: imagePreviewUrl,
								alt: "",
								className: "h-8 w-8 rounded object-cover"
							}) : existingImageUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								...
								children: imageFile ? imageFile.name : existingImageUrl ? "Change image" : "Upload image"
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							ref: fileInputRef,
						...
						saveError && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2 rounded-xl border border-red-500/30 bg-red-500/10 px-4 py-2.5 w-full",
		...
		allCollections.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: allCollections.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CollImage, {
							url: c.imageUrl,
							size: "h-12 w-12"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex-1 min-w-0",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-display text-lg block truncate",
								children: c.name
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `h-2 w-2 rounded-full inline-block ${c.isActive ? "bg-green-400" : "bg-gray-500"}` })]
						})]
					}),
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Table, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CollImage, {
					url: c.imageUrl,
					size: "h-10 w-10"
				}) }),
