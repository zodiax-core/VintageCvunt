...
import { E as PanelsTopLeft, L as FileText, _ as Save, b as Quote, c as Trash2, j as Mail, t as X, w as Pencil, x as Plus } from "../_libs/lucide-react.mjs";
import { t as AdminLayout } from "./AdminLayout-BhQ-pVpk.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/content-Dbh0wBUX.js
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: faqs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "px-5 py-10 text-center font-mono text-[11px] text-chrome-dim",
							children: "No FAQs yet"
						}) : faqs.map((faq) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "inline-flex items-center gap-1 rounded-full border border-chrome/20 bg-chrome/5 px-2 py-0.5 font-mono text-[9px] uppercase tracking-[0.2em] text-chrome-dim",
									children: faq.category
								})
							]
						}, faq._id))
