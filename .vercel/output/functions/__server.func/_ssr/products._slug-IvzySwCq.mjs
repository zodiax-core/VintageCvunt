...
import { t as Route } from "./products._slug-DspBWlV1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/products._slug-IvzySwCq.js
...
function FloatingVideo({ videoUrl }) {
	...
	const handleHoverEnd = (0, import_react.useCallback)(() => {
		if (!isScaling && !hoverLock.current) {
			setIsHovered(false);
			setTouchHover(false);
		}
	}, [isScaling]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		onTap: () => {
			if (!isScaling) showControlsTemporarily();
		},
		initial: {
			opacity: 0,
			scale: 0
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: isScaling && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
				initial: { opacity: 0 },
				animate: { opacity: 1 },
				exit: { opacity: 0 },
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: !isScaling && showHover && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
				initial: { opacity: 0 },
				animate: { opacity: 1 },
				exit: { opacity: 0 },
			...
			isScaling && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			!isScaling && !showHover && !isPlaying && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
