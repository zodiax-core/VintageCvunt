...
import { _ as Save, i as Upload, t as X } from "../_libs/lucide-react.mjs";
import { t as toWebP } from "./image-utils-DlMy0r_R.mjs";
import { t as Route } from "./product._id.edit-D_mV4OCm.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/product._id.edit-DsNdQnJQ.js
...
function EditProduct() {
	...
	const categoryOptions = activeCollections.length > 0 ? activeCollections.map((c) => c.name) : [
		"Outerwear",
		"Footwear",
		"Silverwork",
		"Adornment",
	...
	const removeColor = (c) => setForm((prev) => ({
		...prev,
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								}) : product.imageUrls?.[0] ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex flex-col items-center gap-2",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "h-20 w-20 rounded-xl overflow-hidden border border-chrome/30",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								}) : product.video ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "font-mono text-[10px] text-chrome-dim",
									children: "Video uploaded. Click to replace."
								}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "font-mono text-[10px] uppercase tracking-[0.2em] text-chrome-dim",
