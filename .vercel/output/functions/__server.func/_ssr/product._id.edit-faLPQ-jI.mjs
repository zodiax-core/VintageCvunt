...
import { t as Route } from "./product._id.edit-o-NQEm10.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/product._id.edit-faLPQ-jI.js
...
function EditProduct() {
	...
	const [imageEntries, setImageEntries] = (0, import_react.useState)([]);
	...
	(0, import_react.useEffect)(() => {
		if (product && !initialized) {
			...
			const existing = (product.imageUrls ?? []).map((url, i) => ({
				type: "existing",
				url,
				storageId: product.images[i]
			}));
			setImageEntries(existing);
			if (product.variants && product.variants.length > 0) setVariants(product.variants.map((v) => ({
				name: v.name,
	...
	const handleVariantImage = (idx, file) => {
		...
		setVariants((prev) => prev.map((v, i) => i === idx ? {
			...
			existingImageId: void 0,
			existingImageUrl: void 0
		} : v));
	};
	const validate = () => {
		const errs = {};
	...
	const handleSave = async () => {
		...
		try {
			for (let i = 0; i < imageEntries.length; i++) {
				...
				if (entry.type === "existing") finalImages.push(entry.storageId);
				else {
			...
			for (let i = 0; i < variants.length; i++) {
				...
				let variantImageId = v.existingImageId;
				if (v.imageFile) {
			...
			await updateProduct({
				...
				video: video ?? (videoFile === null && product?.video ? product.video : void 0),
				tags: form.tags,
				sizes: form.sizes,
				colors: [],
				...
				images: finalImages.length > 0 ? finalImages : void 0
			});
			if (oldCategory && oldCategory !== form.category) await removeFromCollection({
				sessionToken: getSessionToken() ?? "",
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							variants.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "No variants — product uses base price only."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "space-y-3",
								children: variants.map((v, idx) => {
									...
									return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
												previewSrc ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
													...
													children: previewSrc ? "Change Image" : "Upload Image"
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
													ref: (el) => {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							imageEntries.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-2",
								children: [imageEntries.map((entry, idx) => {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: videoFile ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								}) : product.videoUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex flex-col items-center gap-2",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("video", {
										...
										className: "font-mono text-[9px] uppercase tracking-[0.2em] text-chrome-dim hover:text-chrome",
										children: "Replace"
									})]
								}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "font-mono text-[10px] uppercase tracking-[0.2em] text-chrome-dim",
