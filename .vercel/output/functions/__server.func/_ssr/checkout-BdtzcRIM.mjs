...
//#region node_modules/.nitro/vite/services/ssr/assets/checkout-BdtzcRIM.js
...
async function queryValidateCoupon(code, subtotal) {
	const { convex } = await import("./convex-WZHxEq9m.mjs");
	const { api } = await import("./api-xr_VpTVu.mjs").then((n) => n.n).then((n) => n.n);
	return await convex.query(api.coupons.validateCoupon, {
		code,
		subtotal
	});
}
