...
import { t as Route } from "./products._slug-Dj_1LFih.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/products._slug-Bf0ZrqN5.js
...
function FloatingVideo({ videoUrl }) {
	...
	const touchTimer = (0, import_react.useRef)(null);
...
function ProductPage() {
	...
	const [showVariantImage, setShowVariantImage] = (0, import_react.useState)(false);
	const [variantError, setVariantError] = (0, import_react.useState)(false);
	...
	const galleryImages = (0, import_react.useMemo)(() => {
		...
		const variantImages = (product.variants || []).map((v) => v.imageUrl).filter((img) => !!img);
		return Array.from(/* @__PURE__ */ new Set([...baseImages, ...variantImages]));
	}, [product]);
	const currentPrice = (0, import_react.useMemo)(() => {
		if (!product?.variants || !selectedColor) return null;
		return product.variants.find((v) => v.name === selectedColor) || null;
	}, [product?.variants, selectedColor])?.price ?? product?.price ?? 0;
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
								...
								children: galleryImages.map((url, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => {
										setSelectedImage(index);
									},
									className: `relative h-20 w-16 shrink-0 overflow-hidden rounded-xl border transition-all ${selectedImage === index ? "border-chrome ring-1 ring-chrome/30" : "border-chrome/20 hover:border-chrome/50"}`,
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
										src: url,
										alt: "",
										className: "h-full w-full object-cover"
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
								...
								children: [
									...
									product.compareAtPrice && product.compareAtPrice > currentPrice && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									product.variants && product.variants.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
												className: `font-mono text-[10px] uppercase tracking-[0.3em] mb-2 ${variantError ? "text-red-400 font-semibold" : "text-chrome-dim"}`,
												children: ["Select Variant ", variantError && " * (Required)"]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "flex flex-wrap gap-2",
												children: product.variants.map((v, i) => {
													return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
														...
														className: `rounded-lg border px-3 py-1.5 font-mono text-[11px] transition-all duration-200 ${selectedColor === v.name ? "border-chrome bg-chrome text-background shadow-md scale-[1.02]" : variantError ? "border-red-500/50 bg-red-500/5 text-red-400 hover:border-red-500/80" : "border-chrome/30 bg-graphite text-chrome hover:border-chrome/60"}`,
														children: [v.name, v.price && v.price !== product.price && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											...
											variantError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "mt-2 font-mono text-[10px] text-red-400",
												children: "Please choose a variant options before proceeding."
											})
										]
									}),
									(!product.variants || product.variants.length === 0) && product.colors && product.colors.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "mt-6",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "font-mono text-[10px] uppercase tracking-[0.3em] text-chrome-dim mb-2",
											children: "Colors"
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											onClick: () => {
												if (product.variants && product.variants.length > 0 && !selectedColor) {
													...
													document.getElementById("variant-selector-section")?.scrollIntoView({
														behavior: "smooth",
														block: "center"
													});
													return;
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "btn-label",
												children: addedToCart ? "Added ✓" : `Add to Cart — ${formatPrice(currentPrice)}`
											})
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
