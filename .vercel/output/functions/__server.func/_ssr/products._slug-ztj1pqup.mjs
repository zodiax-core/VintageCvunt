...
import { t as Route } from "./products._slug-HY22PSWN.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/products._slug-ztj1pqup.js
...
function FloatingVideo({ videoUrl }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: isScaling && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
		initial: { opacity: 0 },
		animate: { opacity: 1 },
		exit: { opacity: 0 },
	...
	}, "fullscreen") }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
		initial: {
			opacity: 0,
			width: 160,
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: isHovered && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
				initial: { opacity: 0 },
				animate: { opacity: 1 },
				exit: { opacity: 0 },
			...
			!isHovered && !isPlaying && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
