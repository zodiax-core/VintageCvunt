...
//#region node_modules/.nitro/vite/services/ssr/assets/analytics-DsF0YCPu.js
...
function Analytics() {
	...
	const monthlyRevenue = useQuery(api.orders.getRevenueByMonth) ?? [];
	const globalStats = useQuery(api.orders.getStats) ?? null;
