...
//#region node_modules/.nitro/vite/services/ssr/assets/SiteFooter-BelWRq_m.js
...
function StatusBadge({ status }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: `${base} ${styles[status.toLowerCase()] || styles.pending}`,
		children: status
	});
}
function TrackOrderOverlay({ open, onClose }) {
	const [orderNumber, setOrderNumber] = (0, import_react.useState)("");
	const [searchTrigger, setSearchTrigger] = (0, import_react.useState)("");
	const inputRef = (0, import_react.useRef)(null);
	const { formatPrice } = useCurrency();
	const order = useQuery(api.orders.getByOrderNumber, searchTrigger ? { orderNumber: searchTrigger.trim() } : "skip");
	(0, import_react.useEffect)(() => {
		if (open) {
			setOrderNumber("");
			setSearchTrigger("");
	...
	const handleSearch = (e) => {
		e.preventDefault();
		if (orderNumber.trim()) setSearchTrigger(orderNumber.trim());
	};
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
						...
						className: "absolute left-5 top-1/2 -translate-y-1/2 text-chrome-dim/50",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z" }),
				...
				children: [
					searchTrigger && order === null && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "py-16 text-center rounded-2xl border border-chrome/20 bg-graphite/40 backdrop-blur",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-display text-2xl text-chrome-dim italic",
							children: "Order not found"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 font-mono text-xs text-chrome-dim/50",
							children: "Please verify the Tracking ID and try again"
						})]
					}),
					searchTrigger && order === void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "py-16 text-center rounded-2xl border border-chrome/20 bg-graphite/40 backdrop-blur",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-mono text-xs text-chrome-dim/50 animate-pulse",
							children: "Searching order database…"
						})
					}),
					order && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-2xl border border-chrome/30 bg-graphite p-6 md:p-8 space-y-6 backdrop-blur shadow-xl",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex flex-wrap items-center justify-between gap-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "font-mono text-[9px] uppercase tracking-[0.25em] text-chrome-dim",
										children: "Tracking details"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
										className: "font-display text-2xl text-foreground mt-1",
										children: order.orderNumber
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
										className: "font-mono text-[9px] uppercase tracking-[0.15em] text-chrome-dim/60 mt-1",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "divider-chrome" }),
							order.status.toLowerCase() !== "cancelled" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "block font-mono text-[9px] uppercase tracking-[0.25em] text-chrome-dim",
									children: "Status Timeline"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "flex items-center gap-1",
									children: STATUS_TIMELINE.map((step, idx) => {
										...
										return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													className: `h-6 w-6 rounded-full flex items-center justify-center font-mono text-[8px] uppercase tracking-[0.15em] border ${completed ? "bg-chrome text-background border-chrome" : "border-chrome/30 text-chrome-dim/40"} ${currentStepIndex === idx ? "ring-2 ring-chrome/30" : ""}`,
													children: completed ? "✓" : idx + 1
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: `font-mono text-[9px] uppercase tracking-[0.15em] hidden sm:inline ${completed ? "text-chrome" : "text-chrome-dim/40"}`,
													children: step
												})]
											}), idx < STATUS_TIMELINE.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `flex-1 h-px mx-2 ${completed ? "bg-chrome/50" : "bg-chrome/10"}` })]
										}, step);
									})
								})]
							}),
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: order.items.map((item, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex justify-between items-start gap-4 text-xs font-mono",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "min-w-0 flex-1",
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													...
													(item.size || item.color) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														className: "text-[9px] text-chrome-dim/60 mt-0.5",
														children: [item.size, item.color].filter(Boolean).join(" / ")
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
														className: "text-[10px] text-chrome-dim",
									...
									className: "space-y-3 font-mono text-xs text-chrome-dim",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "block font-mono text-[9px] uppercase tracking-[0.25em] text-chrome-dim",
											children: "Address & Summary"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "rounded-xl border border-chrome/10 bg-graphite-2 p-3 text-[10px] leading-relaxed",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Subtotal" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: formatPrice(order.subtotal) })]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex justify-between text-[11px]",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Shipping" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: order.shipping === 0 ? "Free" : formatPrice(order.shipping) })]
												}),
												order.discount && order.discount > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex justify-between text-[11px] text-green-400",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Discount" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["-", formatPrice(order.discount)] })]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex justify-between text-[12px] text-chrome font-semibold border-t border-chrome/15 pt-1 mt-1",
...
function SiteNav() {
	...
	const [trackOpen, setTrackOpen] = (0, import_react.useState)(false);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrackOrderOverlay, {
			open: trackOpen,
