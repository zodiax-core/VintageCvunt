...
import { A as Pencil, E as Plus, S as Save, _ as Ship, d as Trash2, q as Globe, tt as CreditCard, w as Receipt } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/setting-Bb7lE0PQ.js
			...
			activeTab === "shipping" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: shippingRatesData.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-sm text-muted-foreground text-center py-4",
							children: "No shipping rates yet"
						}) : shippingRatesData.map((rate) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											onClick: () => editShipping(rate),
											className: "btn-chrome btn-chrome-inner p-1.5 rounded-lg",
											...
											className: "btn-chrome btn-chrome-inner p-1.5 rounded-lg text-red-400",
