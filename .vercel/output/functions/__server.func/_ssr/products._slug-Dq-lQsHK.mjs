...
import { t as Route } from "./products._slug-DG4S9TA5.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/products._slug-Dq-lQsHK.js
...
function FloatingVideo({ videoUrl }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
		...
		className: `fixed z-50 overflow-hidden bg-black shadow-2xl border border-white/20 group ${isMinimized ? "cursor-pointer bottom-4 right-4" : isScaling ? "inset-0 m-auto" : "bottom-20 right-6"}`,
		...
		children: [
			...
			isMinimized && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "h-9 w-9 rounded-full bg-black/60 backdrop-blur text-white grid place-items-center pointer-events-none",
