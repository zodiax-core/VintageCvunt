...
import { H as Check, R as CircleX, c as Trash2, h as Search, t as X } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/review-BHxLyEWY.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var mockReviews = [
	{
		id: 1,
		product: "Obsidian Tailcoat",
		customer: "Elena Voss",
		rating: 5,
		content: "Absolutely stunning piece. The tailoring is impeccable and the fabric feels luxurious. Worth every penny.",
		date: "2026-07-18",
		status: "Approved"
	},
	{
		id: 2,
		product: "Argentine Cuff",
		customer: "Marcus Webb",
		rating: 4,
		content: "Beautiful craftsmanship. The silver detailing is exquisite. Slightly heavy on the wrist but overall a great accessory.",
		date: "2026-07-17",
		status: "Approved"
	},
	{
		id: 3,
		product: "Noir Leather Boots",
		customer: "Clara Hemlock",
		rating: 5,
		content: "Most comfortable boots I've ever owned. Broke in after just a few wears. The leather is top quality.",
		date: "2026-07-16",
		status: "Pending"
	},
	{
		id: 4,
		product: "Silver Mesh Veil",
		customer: "Julian Frost",
		rating: 3,
		content: "Looks great but the mesh is a bit delicate. Afraid it might tear with regular use. Good for special occasions.",
		date: "2026-07-15",
		status: "Approved"
	},
	{
		id: 5,
		product: "Chrome Signet Ring",
		customer: "Sylvia Kaine",
		rating: 5,
		content: "Perfect fit and the engraving is razor sharp. My husband loved it. Will order more as gifts.",
		date: "2026-07-14",
		status: "Approved"
	},
	{
		...
		rating: 4,
		content: "Great quality overall. The lining is beautiful. Only complaint is the sleeves were slightly long.",
		date: "2026-07-13",
		status: "Rejected"
	},
	{
		...
		customer: "Priya Nair",
		rating: 5,
		content: "Exquisite design. Got so many compliments at the gala. The clasp mechanism is smooth and secure.",
		date: "2026-07-12",
		status: "Pending"
	},
	{
		...
		rating: 4,
		content: "Solid boots with great grip. Took a while to break in but now they fit like a glove. Would recommend.",
		date: "2026-07-11",
		status: "Approved"
	},
	{
		...
		rating: 3,
		content: "Pretty but overpriced for what it is. The silver finish is starting to wear off after only a few uses.",
		date: "2026-07-10",
		status: "Pending"
	},
	{
		...
		rating: 5,
		content: "Perfect craftsmanship. The weight feels substantial and the chrome finish is flawless. My new favorite accessory.",
		date: "2026-07-09",
		status: "Approved"
	}
];
...
function Reviews() {
	const [reviews, setReviews] = (0, import_react.useState)(mockReviews);
	...
	const filtered = reviews.filter((r) => {
		const matchesSearch = r.product.toLowerCase().includes(search.toLowerCase()) || r.customer.toLowerCase().includes(search.toLowerCase());
