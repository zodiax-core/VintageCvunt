...
import { t as Route } from "./shop-DvjMsdCS.mjs";
import { t as useInView } from "../_libs/react-intersection-observer.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/shop-rV1BMVNT.js
...
function Shop() {
	...
	const [visibleCount, setVisibleCount] = (0, import_react.useState)(24);
	...
	(0, import_react.useEffect)(() => {
		if (inView && visibleCount < filtered.length) setVisibleCount((prev) => Math.min(prev + 12, filtered.length));
	}, [
		inView,
		filtered.length,
		visibleCount
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				className: "sticky top-[68px] md:top-[84px] z-40 border-y border-chrome bg-graphite transition-all duration-300",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						filtered.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: visibleProducts.map((product) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: "/products/$slug",
						...
						visibleCount < filtered.length && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-16 flex flex-col items-center gap-4",
							ref: loadMoreRef,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-4 w-4 rounded-full border-2 border-chrome-dim border-t-chrome animate-spin" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
