...
import { t as Route } from "./shop-YsMaYjYk.mjs";
import { t as useInView } from "../_libs/react-intersection-observer.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/shop-UvZrxCOv.js
...
function Shop() {
	...
	const [visibleCount, setVisibleCount] = (0, import_react.useState)(5);
	...
	(0, import_react.useEffect)(() => {
		if (inView && visibleCount < filtered.length) setVisibleCount((prev) => Math.min(prev + 5, filtered.length));
	}, [
		inView,
		filtered.length,
		visibleCount
