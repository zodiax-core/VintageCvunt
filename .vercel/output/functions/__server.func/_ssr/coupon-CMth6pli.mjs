...
import { C as Pencil, R as DollarSign, S as Percent, a as Truck, c as Trash2, t as X, x as Plus } from "../_libs/lucide-react.mjs";
import { t as AdminLayout } from "./AdminLayout-DMRer5-I.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/coupon-CMth6pli.js
...
function Coupons() {
	...
	function handleSave() {
		if (editingId) updateCoupon({
			id: editingId,
			...form.code !== void 0 && { code: form.code },
			...form.type !== void 0 && { type: form.type },
			...
			const expiresAt = form.expiry ? new Date(form.expiry).getTime() : Date.now() + 365 * 24 * 60 * 60 * 1e3;
			createCoupon({
				code: form.code,
				type: form.type,
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, { children: editingId ? "Edit Coupon" : "Add Coupon" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, {
							className: "font-mono text-[10px] uppercase tracking-[0.2em] text-chrome-dim",
							children: editingId ? "Update coupon details" : "Create a new discount coupon"
						})] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
