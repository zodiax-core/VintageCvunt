...
import { dt as Check, it as Copy, o as Upload, t as X } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/checkout-CYQWSCaX.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var jazz_cash_logo_default = "/assets/jazz-cash-logo-IGnIc5DV.png";
var EASE = [
	.16,
	1,
	.3,
...
var JAZZCASH_DETAILS = {
	accountHolder: "Anabiya Kashif",
	accountNumber: "0331-6809983"
};
function JazzCashLogo({ size = 22 }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
		src: jazz_cash_logo_default,
		alt: "JazzCash",
		width: size,
		height: size,
...
function CopyButton({ text }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...
		children: copied ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "h-3.5 w-3.5 text-green-400" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Copy, { className: "h-3.5 w-3.5 text-chrome-dim" })
	});
}
function Checkout() {
	...
	const [screenshotFile, setScreenshotFile] = (0, import_react.useState)(null);
	const [screenshotPreview, setScreenshotPreview] = (0, import_react.useState)(null);
	const [uploadingScreenshot, setUploadingScreenshot] = (0, import_react.useState)(false);
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
										className: `flex items-start gap-4 cursor-pointer rounded-2xl border p-4 transition-all ${paymentMethod === "cash on delivery" ? "border-chrome/60 bg-chrome/5" : "border-chrome/20 bg-graphite hover:border-chrome/35"}`,
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
											type: "radio",
											name: "payment",
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "h-10 w-10 rounded-xl bg-graphite-2 border border-chrome/20 flex items-center justify-center shrink-0",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
													className: "h-5 w-5 text-chrome-dim",
													viewBox: "0 0 24 24",
													fill: "none",
													stroke: "currentColor",
													strokeWidth: "1.5",
													children: [
														...
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M6 12h.01M18 12h.01" })
													]
												})
												...
												children: "Pay in cash when your parcel arrives"
											})] })]
										})]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: `rounded-2xl border transition-all overflow-hidden ${isOnlinePayment ? "border-chrome/60 bg-chrome/5" : "border-chrome/20 bg-graphite hover:border-chrome/35"}`,
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												...
												className: "flex items-center gap-3 flex-1",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													className: "h-10 w-10 rounded-xl bg-graphite-2 border border-chrome/20 flex items-center justify-center shrink-0 overflow-hidden",
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(JazzCashLogo, { size: 28 })
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "font-mono text-sm text-foreground",
													children: "JazzCash"
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "font-mono text-[10px] text-chrome-dim mt-0.5",
													children: "Transfer via JazzCash"
												})] })]
											})]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: isOnlinePayment && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
											initial: {
												opacity: 0,
												height: 0
											},
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "rounded-xl border border-chrome/15 bg-background/60 p-4 space-y-3",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														className: "font-mono text-[9px] uppercase tracking-[0.15em] text-chrome-dim/60 mb-1",
														children: "Account Holder"
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														className: "flex items-center",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															className: "font-mono text-sm text-foreground",
															children: JAZZCASH_DETAILS.accountHolder
														})
													})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														className: "font-mono text-[9px] uppercase tracking-[0.15em] text-chrome-dim/60 mb-1",
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															className: "font-mono text-sm text-foreground",
															children: JAZZCASH_DETAILS.accountNumber
														}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CopyButton, { text: JAZZCASH_DETAILS.accountNumber })]
													})] })]
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														className: "font-mono text-[9px] uppercase tracking-[0.15em] text-chrome-dim mb-2",
														children: "Upload Payment Screenshot"
													}),
													screenshotPreview ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className: "relative rounded-xl overflow-hidden border border-chrome/30 bg-background/50",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
															...
															children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "h-3.5 w-3.5 text-chrome-dim" })
														})]
														...
														children: [
															/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Upload, { className: "h-5 w-5 text-chrome-dim" }),
															/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																className: "font-mono text-[10px] text-chrome-dim",
																children: "Click to upload screenshot"
															}),
															/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																className: "font-mono text-[9px] text-chrome-dim/50",
																children: "PNG, JPG, WEBP up to 5 MB"
															})
														]
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "btn-label",
												children: uploadingScreenshot ? "Uploading…" : submitting ? "Processing…" : "Place Order"
											})
										}),
